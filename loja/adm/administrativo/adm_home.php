...
<head>
    ...
    <!--========== Title ==========-->
    <title>Han Glint</title>

    <!--================== LINK THUMBNAIL META TAGS ===================-->
    <!-- MS Tile - for Microsoft apps-->
    <meta name="msapplication-TileImage" content="assets/img/ThumbnailLinkImg.jpg" />
    <!-- fb & Whatsapp -->
    <meta property="og:site_name" content="HanGlint" />
    <meta property="og:title" content="HanGlint" />
    <meta property="og:description" content="HanGlint! " />
    <!-- IMG URL: -->
    <meta property="og:image" content="assets/img/ThumbnailLinkImg.jpg" />
    ...
    <main class="l-main">
        ...
        <section class="home" id="home">
            <div class="home_container bd-container bd-grid">
                <div class="home_data">
                    <h1 class="home_title" style="font-size: 36px; color:#5c84ac;">Seja Bem-vindo ao CGP</h1>
                    <h2 class="home_subtitle" style="font-size: 28px;">Ache aqui  o projeto <br> perfeito para você! 😍</h2>
                    <a href="../projetos/projetos.php" class="button">Veja os projetos aqui!</a>
                </div>

                <!-- <img src="assets/img/home.png" alt="Home image" class="home_img" /> -->
            </div>
        </section>
            ...
            <div class="about_container bd-grid">
                <div class="about_data">
                    ...
                    <p class="about_description">
                        “In the dynamic Korean startup scene, We’ve had the privilege of observing numerous successful entrepreneurs, R&Ds, and PMs.
                        <br><br> They all share a common trait: an unwavering commitment to rapid self-improvement, resulting in remarkable achievements. Inspired by their journeys, We too dream of a day when everyone accelerates toward success, realizing their dreams, sharing love, and achieving prosperity.
                        <br><br> I firmly believe that language cannot be a barrier to our dreams.” 😎
                    </p>
                    <!-- <a href="#app" class="button">Gostou? Veja agora!</a> -->
                    <a href="https://linkedin.com/in/benjamin-s-k" class="button">CEO Profile</a>
                </div>

                <img src="assets/img/about.png" alt="Ingredientes naturais" class="about_img" />
            </div>
        </section>
        ...
        <div class="services_container bd-grid">
          <div class="services_content">
            ...
            <h3 class="services_title">Comida Excelente</h3>
            <p class="services_description">
              Os melhores restaurantes e mercados da sua região são parceiros
              Uber Eats!
            </p>
          </div>
          ...
          <div class="services_content">
            ...
            <h3 class="services_title">Entrega Rápida</h3>
            <p class="services_description">
              Os melhores restaurantes e mercados da sua região são parceiros
              Uber Eats!
            </p>
          ...
          <div class="services_content">
            ...
            <h3 class="services_title">Cardápio Muuito Diverso</h3>
            <p class="services_description">
              Os melhores restaurantes e mercados da sua região são parceiros
              Uber Eats!
            </p>
      ...
      <!--========== FOODS ==========-->
        ...
        <span class="section-subtitle">Os melhores</span>
        <h2 class="section-title">Pratos da Semana</h2>

        <div class="foods_container bd-grid">
          <div class="foods_content">
            <img src="assets/img/plate1.png" alt="" class="foods_img" />
            <h3 class="foods_name">Salada & Barbecue</h3>
            <span class="foods_detail">Refeição saudável</span>
          ...
          <div class="foods_content">
            <img src="assets/img/plate2.png" alt="" class="foods_img" />
            <h3 class="foods_name">Salada com Abacate</h3>
            <span class="foods_detail">Refeição saudável</span>
          ...
          <div class="foods_content">
            <img src="assets/img/plate3.png" alt="" class="foods_img" />
            <h3 class="foods_name">Salada com Cebola</h3>
            <span class="foods_detail">Refeição saudável</span>
        ...
        <div class="app_container bd-grid">
          <div class="app_data">
            <span class="section-subtitle app_initial">Comece agora!</span>
            <h2 class="section-title app_initial">Instale nosso aplicativo</h2>
            <p class="app_description">
              Apenas clique abaixo, instale o aplicativo e faça seus pedidos de
        ...
        <section class="contact section bd-container" id="contact">
            <div class="contact_container bd-grid">
                <div class="contact_data">
                    <span class="section-subtitle contact_initial">Need More Info?</span>
                    <h2 class="section-title contact_initial">Contact</h2>
                    <p class="contact_description">
                        Currently based in Seoul, South Korea.
                        <br> Open to all interested in learning Korean!
                        <br>If you have any inquiries, feel free to email us! 😉
                    </p>
                </div>

                <div class="contact_button">
                    <a href="https://forms.gle/7vGK5AZ47vz4tEyQ7" class="button">Inquiry</a>
                </div>
            </div>
        </section>
    </main>
    ...
    <footer class="footer section bd-container">
        <div class="footer_container bd-grid">
            <div class="footer_content">
                <b class="footer_logo">
                    <img src="assets/img/glint_logo.png">
                </b>

                <span class="footer_description">Be the star of your tribes</span>
            ...
            <div class="footer_content">
                <h3 class="footer_title">Upcoming</h3>
                <ul>
        ...
        <div class="footer_content">
          ...
          <ul>
            ...
            <li><a href="#foods" class="footer_link">Pratos da semana</a></li>
          </ul>
        </div>
      </div> -->
            ...
            <p class="footer_copy">
                &#169; CopyRight, 2024
                <a href="https://github.com/TunaLee/hanglint" class="footer_link" target="_blank">
                    HanGlint
                </a>
            </p>
    </footer>
